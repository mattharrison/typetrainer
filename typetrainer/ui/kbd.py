...
nNorman_keyboard = {
 'name': 'nNorman',
 'keys': [
  [49,   10,  11,  26,  27,  34,  15,  16,  17,  18,  19,  20,  21,  backspace],
  [tab,   24,  25,  40,  41,  45,  44,  30,  27,  46,  47,  34,  35,  51],
  [caps,   38,  39,  26,  28,  42,  29,  57,  31,  32,  43,  48,  ret],
  [shift,    52,  53,  54,  55,  56,  33,  58,  59,  60,  61,  shift],
  [ctrl,    fnkey, win,  alt,         space,          alt,  menu, ctrl]
 ],
 'gap': nNorman_gap,
 'sizes': {
 ...
 'offsets': {},
 'width': 14 + 13*nNorman_gap,
 'height': 5 + 4*nNorman_gap,
 'zones': [
    ([3, 4, 5, 7, 8, 9, 10, 13], [1, 2, 3, 4, 5, 1, 2, 3, 0]),
    ([1, 2, 3, 4, 6, 8, 9, 10], [0, 1, 2, 3, 4, 5, 1, 2, 3]),
    ([1, 2, 3, 4, 6, 8, 9, 10, 12 ], [0, 1, 2, 3, 4, 5, 1, 2, 3, 0]),
